...
:Contact: point@pricklysoft.org 
:Web Site: <www.pricklysoft.org>
:Date: $Date: 2007/12/14 16:42:18 $
...
Traithull is written in Python and requires Python version 2.3 or
higher. Python is available for all platforms/operating systems
(http://www.python.org)
